...
class BlockDetector:
    def __init__(self, img_size, mode='height', small_block_size=25, large_block_size=38, max_block_num=6, depth_margin=2):
        ...
        self.boarder_pos = np.array([[187, 116], [1083, 720]])
        self.base_pos = np.array([[537, 424], [725, 720]])
        ...
        # cv2.namedWindow('final_contours')
    ...
    def find_centers_hierarchy(self, img_depth):
        ...
        for cnt in contours_depth_all:
            ...
            lower_bound = int(max_height - 4 * self.depth_margin)
            upper_bound = int(max_height + 4 * self.depth_margin)
        ...
        #             print(rect)
        #         print(top_rects)
        # cv2.imshow('final_contours', tmp_rgb_final)
